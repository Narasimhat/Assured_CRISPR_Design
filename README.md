...
- Validation primers are searched by Tm, GC, homopolymer, hairpin, self-dimer, hetero-dimer, and pair-Tm criteria. Fallback placements never receive an ordering-ready result.
